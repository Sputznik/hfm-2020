...
add_action('wp_enqueue_scripts',function(){
  ...
  wp_enqueue_style( 'hfm-css', get_stylesheet_directory_uri().'/assets/css/hfm-twenty-twenty.css', array('sp-core-style'), '1.0.0' );
	wp_enqueue_style( 'extra-css', get_stylesheet_directory_uri().'/assets/css/extra.css', array('sp-core-style', 'hfm-css'), '1.0.0' );
