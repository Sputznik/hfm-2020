...
add_action('wp_enqueue_scripts',function(){
  ...
  wp_enqueue_style( 'hfm-css', get_stylesheet_directory_uri().'/assets/css/hfm-twenty-twenty.css', array('sp-core-style'), time() ); //'1.0.7'
  ...
  wp_enqueue_script( 'hfm-video-slider', get_stylesheet_directory_uri().'/assets/js/hfm-video-slider.js', array( 'jquery' ), time(), true );
},99);
